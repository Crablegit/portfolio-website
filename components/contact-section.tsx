    ...
    <section id="contact" className="py-20 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="pt-6">
            <p className="text-sm text-muted-foreground text-center mb-4">{t("contact.socialTitle")}</p>
            <div className="flex justify-center gap-4">
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="p-3 rounded-xl bg-navy-100 dark:bg-navy-800 border border-navy-200 dark:border-navy-700 hover:border-emerald-500 hover:text-emerald-500 transition-colors"
                  title={social.name}
                >
                  {social.icon}
                </motion.a>
